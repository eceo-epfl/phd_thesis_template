# Template for the EPFL PhD thesis (ECEO Version)

This template is based on the EPFL PhD thesis template and draws inspiration from the former theses of the lab. Feel free to add any helpful notes. The template will be passed along to the next PhD graduates in the lab :)

Here are the files:
- Main file: my_thesis.tex
- main folder: Chapters.tex
- head folder: abstract.tex, acknowledgements.tex, and settings_custom.tex
- tail folder: cv.pdf, appendix.tex, put bib here
- images folder: put images here

Good luck!

===============================================================
Here is the original README.md from the EPFL template for your reference.
